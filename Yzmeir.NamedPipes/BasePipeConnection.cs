...
namespace Yzmeir.NamedPipes
{
    ...
    /// <see cref="Yzmeir.NamedPipes.ClientPipeConnection">ClientPipeConnection</see> 
    /// and <see cref="Yzmeir.NamedPipes.ServerPipeConnection">ServerPipeConnection</see> 
    /// classes, used for client and server applications respectively, which communicate
    /// using NamesPipes.
    /// </remarks>
    #endregion
    public abstract class BasePipeConnection : IInterProcessConnection
    {
        #region Comments
        /// <summary>
